"use strict";
function gioco(numeroGiocatore1, numeroGiocatore2) {
    // Genera un numero casuale compreso tra 1 e 100
    const numeroCasuale = Math.floor(Math.random() * (100 - 1) + 1);
    // Calcola le differenze tra i numeri dei giocatori e il numero casuale
    const diffGiocatore1 = Math.abs(numeroGiocatore1 - numeroCasuale);
    const diffGiocatore2 = Math.abs(numeroGiocatore2 - numeroCasuale);
